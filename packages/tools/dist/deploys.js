...
exports.listDeploysTool = exports.getJobStatusTool = exports.rollbackDeployTool = exports.startDeployTool = exports.DeployJobSchema = exports.DeploySpecSchema = void 0;
...
exports.DeployJobSchema = zod_1.z.object({
    id: zod_1.z.string(),
...
exports.startDeployTool = (0, tools_1.createTool)({
    ...
    outputSchema: exports.DeployJobSchema,
...
exports.listDeploysTool = (0, tools_1.createTool)({
    ...
    outputSchema: zod_1.z.object({
        ...
        jobs: zod_1.z.array(exports.DeployJobSchema),
    }),
    execute: async ({ context }) => {
        const db = (0, persistence_1.getDb)();
        const conditions = [];
